...
here::i_am("code/adfgobserver_NSE.R")
...
save(wobserverE.df, file=here("data", "wobserverE_NSE.Rda"))
save(wobserverO.df, file=here("data", "wobserverO_NSE.Rda"))