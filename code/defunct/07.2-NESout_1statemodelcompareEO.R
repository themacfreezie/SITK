...
## what about trying to reduce the number of parameters in the even/odd models?
# instead of having to pull in estimates from the 2-run model
  # because I really don't think that's kosher...
...
model.list_1stE <- list(
  B = b.model, U = u.model, Q = q.model,
  Z = z.model_1state, A = a.model, R = r.model,
  x0 = x.model, V0 = v.model, tinitx = 1,
  C= c.model_1state, c = pdoE, D = dE.model, d = obE)
...
## still not enough of a reduction in params..
