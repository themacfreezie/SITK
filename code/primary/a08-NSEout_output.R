...
# plots for just two states (Indian River not separate)
# load in ssE (from 05E)
...
# combine
STK3EsteNSE <- (ylab | (STK2steNSE_E / STKsteNSE_O)) +
  plot_layout(widths = c(0.01, 1))
STK3EsteNSE
ggsave(here("output", "figures", "STK3EsteNSE.png"), plot=STK3EsteNSE, device="png", dpi=300)

# combine
STK3OsteNSE <- (ylab | (STKsteNSE_E / STK2steNSE_O)) +
  plot_layout(widths = c(0.01, 1))
STK3OsteNSE
ggsave(here("output", "figures", "STK3OsteNSE.png"), plot=STK3OsteNSE, device="png", dpi=300)