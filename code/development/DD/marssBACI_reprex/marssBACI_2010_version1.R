...
# set loc
here::i_am("marssBACI_2010_version1.R")
...
if(!file.exists(here("MARSSsummary_Rde2010.rds"))){
...
saveRDS(marsssummary_Rde, file=here("MARSSsummary_Rde2010.rds"))
}
marsssummary_Rde <- readRDS(file=here("MARSSsummary_Rde2010.rds"))
...
if(!file.exists(here("MARSSsummary_Rvc2010.rds"))){
  # 4 Covariate Specifications
  for (c_idx in 1:length(c_models)) {
  ...
  saveRDS(marsssummary_Rvc, file=here("MARSSsummary_Rvc2010.rds"))
}
marsssummary_Rvc <- readRDS(file=here("MARSSsummary_Rvc2010.rds"))
...
if(!file.exists(here("marsssummary_Rsite2010.rds"))){
  # 4 Covariate Specifications
  for (c_idx in 1:length(c_models)) {
  ...
  saveRDS(marsssummary_Rsite, file=here("MARSSsummary_Rsite2010.rds"))
}
marsssummary_Rsite <- readRDS(file=here("MARSSsummary_Rsite2010.rds"))
