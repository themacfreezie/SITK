...
if(!file.exists(here("marss_summary.rds"))){
...
saveRDS(marss_summary, file=here("marss_summary.rds"))
}
marss_summary <- readRDS(file=here("marss_summary.rds"))
